							...
							<form className="login-box__form">
								...
								<div className="user-box">
									...
									<input
										...
										name="password"
										onChange={
											userAcc ? doNothing : (e) => setPassword(e.target.value)
										}
										value={password}
										required
										placeholder="..."
						...
						<div className="loginPage__info__instruction">
							...
							<motion.div layout className="details">
								<motion.p layout>
									...
									MyFxBook website. Put in same email and password you have on
									MyFxBook account as log in details.
								</motion.p>
								{userAcc ? (
									<motion.p layout>
										<span>OK GOOD!!!</span> <br /> Now select your preferable
										account to be displayed on your dashboard
									</motion.p>
								) : (
